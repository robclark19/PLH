...
setwd('C:/Users/crossley/OneDrive - University of Delaware - o365/Desktop/Desktop/Doris_Lagos-Kutz_projects/PotatoLeafHopper_STN')
...
# Curated data
pheno = read.table('./data/PLH_pheno_weather_land.txt',sep='\t',as.is=T,check.names=F,header=T)
